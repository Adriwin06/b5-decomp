...
//
// THE OLD PLACEHOLDER WAS ALSO A SIZE PIN, which is why it has to go rather than grow:
...
// either way) and the layout gate's sizeof == 8 still holds -- which is exactly why nothing
...
// definitions and there is now one. Size, not byte-identity -- the pre-change binary was
...
namespace Vehicle         { struct VehicleManagerOutputBuffer; } // home BrnVehicleManagerIO.h (the "VehManager" stack buffer Update creates)
    ...
    struct PhysicsModule : public CgsModule::ModuleSingleBuffered
    {
        ...
        //
        // THE PARAMETER IS THE **SIMULATION MODULE'S** INPUT BUFFER, NOT PhysicsModuleIO's.
    ...
    private:
        ...
        // these were raw free functions over u8* in the TU; they are
        ...
        // ==========================================================================
        // (conductor wave -- PhysicsModule::Update @0x825B0640
        ...
        //
        // mePrepareStage / meReleaseStage SHADOW two same-named PRIVATE members of the
