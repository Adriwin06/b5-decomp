...
namespace Deformation
{
    ...
    //   DeformationDebugComponent::Construct              @0x82606480
    //   DeformationDebugComponent::OnSelectedRigChange    @0x825DF408
    //   DeformationDebugComponent::OnSelectedSensorChange @0x825DF310
    // WHY: PhysicsModule::Construct @0x825AE308 was a live empty stub; un-stubbing it needs
    // DeformationManager::Construct, which constructs this component. THIS TU cannot be mounted --
    // a MEASURED trial link (task #116, M2) put it at 53 unresolved externals, 25 of them from
    // OnActivate and 12 from RenderWorld (the debug-menu registration + Debug3DImmediateRender
    // surface). NONE of the 53 came from the three functions above: the Construct chain needs
    // nothing this TU does not already have. TO RE-MERGE: close the 53, mount this TU, move back.
    // ==============================================================================================
