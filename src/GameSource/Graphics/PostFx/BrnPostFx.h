...
// ==================================================================================================
// [FLAG PC bring-up] THE PC COMPOSITE GATE. Two entry points BrnRendererModule::Render drives the
// post-fx singleton through on this build, plus the query that tells it whether the composite can
// draw this frame. The console had none of them -- Render calls BrnPostFx::Construct and
// BrnPostFx::Render directly -- so they carry only what PC needs and the class above keeps its
// unguarded console reads. Defined in BrnPostFx.cpp. RETIRED WITH THE BRING-UP.
// ==================================================================================================
...
// call this function stands in for. It is DEFERRED on PC to the frame that builds the post-fx
...
// BrnRendererModule::Render asks it BEFORE scheduling the blend. RETIRED WITH THE BRING-UP.
